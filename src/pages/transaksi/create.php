...
<script>
    $(document).ready(function(){
        $("#tambahListProduk").on("click", function(){
            ...
            var tampilanHtml = '<div class="listProduk" id="'+ nextId +'"><select name="idItem[]"><option value="-">Nama Produk</option><option value="namaProduk1">Produk 1</option><option value="namaProduk2">Produk 2</option><option value="namaProduk3">Produk 3</option></select><input type="number" name="kuantitiItem[]" min="1" placeholder="Qty"><input type="text" placeholder="pengurangItem" name="pengurangItem[]"><button class="hapusList" value="'+numberNextId+'"><i class="fas fa-minus-circle"></i></button></div>';
